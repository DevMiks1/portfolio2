    ...
    <div>
      ...
      <section id="home">     
        <div className="container1 ">
          <div className="home pt-16 grid md:grid-cols-2 ">
            ...
            <div className="z-10">        
              <img src={astronaut} alt=" personal profile" className="astraunot mx-auto h-[300px]  cursor-pointer sm:mx-auto md:h-[550px] md:my-20 lg:my-0 lg:h-[700px]"/>
            </div>
          </div>
        </div>
