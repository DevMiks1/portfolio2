      ...
      <section id="home">     
        <div className="container1 ">
          <div className="grid md:grid-cols-2 ">
            <div className="pt-24 md:py-60 text-center leading-normal md:text-left md:pl-10 lg:pr-10 ">
            ...
            <div className="z-10">        
              <img src={astronaut} alt="personal profile" className=" h-[300px]  cursor-pointer sm:mx-auto md:h-[550px] md:my-20 lg:my-0 lg:h-[700px]"/>
            </div>
          </div>
        </div>
