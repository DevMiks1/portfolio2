      ...
      <section className="py-20">
        <div className="py-10">
          <div className="container1">
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 justify-center items-center gap-20 py-20 mx-4 my-4" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="1000">
              {TechList.map((skill) => {
                const { id, img } = skill;
                return (
                  <motion.div
