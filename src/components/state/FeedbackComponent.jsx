            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3">
              <div className="col-span-2 py-3">
                ...
                <Carousel showThumbs={false} autoPlay interval={1500} stopOnHover={false} showStatus={false} showArrows={false} infiniteLoop>
                  ...
                  <div>
                    <img src={feedback} alt="" className="h-[300px] lg:h-[460px] w-full"  />
                  </div>
                  {/* 2nd image in the carousel */}
                  <div>
                    <img src={feedback1} alt="" className="h-[300px] lg:h-[460px] w-full"  />
                  </div>
                  {/* 3rd image in the carousel */}
                  <div>
                    <img src={feedback2} alt="" className="h-[300px] lg:h-[460px] w-full"  />
                  </div>
                </Carousel>
              </div>
              <div className="py-3">
